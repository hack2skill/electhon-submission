...
class Docs extends React.PureComponent {
  ...
  // sendImage_old = async (img) => {

  //   const formData = new FormData();
  //   formData.append('image', dataURItoBlob(img), 'image.jpg');

  //   const response = await fetch('http://192.168.129.105:3000/pov', 
  //     {
  //       method: 'POST',
  //       body: { "file": formData, "shouldGivePOV": "true", 
    ...
    return [
      ...
      <Main key="section">
        <Wrapper>
          <Section>
            <HeadingGroup>
              <Heading>Click Image of Inked Finger</Heading>
            </HeadingGroup>
            <CameraWrapper>
